        ...
        <>
            <div className={`main-container relative`}>
                ...
                <div className="sub-container">
                    ...
                    <div className={`duration-1000 wh-full gap-6 overflow-y-auto fullXl:overflow-hidden fullXl:gap-8 grid pb-20 lg:pb-0 lg:grid-cols-[2fr_2.2fr_2fr] fullXl:grid-cols-3 justify-items-center
                        `}>
